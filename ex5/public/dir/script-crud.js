...
`;
    ...
    if (!formAdicionarTarefa) {
        throw Error('Caro colega, o elemento formAdicionarTarefa não foi encontrado. Favor rever. ');
    }
    if (!textarea) {
        throw Error('Caro colega, o elemento textarea não foi encontrado. Favor rever. ');
    }
    btnAdicionarTarefa.onclick = (e) => {
